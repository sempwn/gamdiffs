# Getting help with gamdiffs

Thanks for using gamdiffs! Before filing an issue, there are a few
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/sempwn/gamdiffs/issues/new).
...
requests](https://github.com/sempwn/gamdiffs/issues) to make sure the
