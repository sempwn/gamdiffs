# Contributing to gamdiffs

This outlines how to propose a change to gamdiffs. For more detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("sempwn/gamdiffs", fork = TRUE)`.
...
Code of Conduct](https://sempwn.github.io/gamdiffs/CODE_OF_CONDUCT.md).
